...
def main():
    ...
    parser.add_argument('-c', default=None, type=str, help='name of fcl file')
    ...
    parser.add_argument('-M',type=str,default=None,help='fake argument')
 ...
 #   parser.add_argument('--projectID', type=int, default=0, help='integer that identifies the project, samweb/dd/wfs')
  #  parser.add_argument('--sam_web_uri',type=str, help='samweb url for the project')
    ...
    if args.c == None:
        print ("You must provide a fcl file with -c ")
        sys.exit(1)
