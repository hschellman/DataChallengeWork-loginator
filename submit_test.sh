...
python submit_dd_jobs.py --dataset=schellma:run5141recentReco --query_limit=10 --fcl=test.fcl --nevents=400 --load_limit=4 --appFamily=LArSoft --appName=pdsp_det_reco --appVersion=${DUNESW_VERSION}
