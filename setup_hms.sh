...
# get Jake's pip install of data dispatcher and metacat.  I need to make my own versins
...
#export PYTHONPATH=$DAPP/myvenv/lib/python3.9/site-packages:$PYTHONPATH
export HERE=$PWD
...
#source $DAPP/myvenv/bin/activate
kx509
source ~/proxy.sh
